                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            <a href="/" class="<?= classNav('/') ?>  rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
                            <a href="/about" class="<?= classNav('/about') ?> rounded-md px-3 py-2 text-sm font-medium">About</a>
                            <a href="/posts" class="<?= classNav('/posts') ?> rounded-md px-3 py-2 text-sm font-medium">Posts</a>
                            <a href="/contact" class="<?= classNav('/contact') ?> rounded-md px-3 py-2 text-sm font-medium">Contact</a>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
