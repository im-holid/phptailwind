...
<main>
    <div class="mx-auto max-w-7xl py-6 px-8">
        <form method="post" action="/posts">
            ...
            <input name="__method" value="UPDATE" type="hidden" />
            ...
            <div class="flex flex-col w-full gap-4">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 justify-between">
                        ...
                        <div>:</div>
                        <Input value="<?= $post['title'] ?? '' ?>" required type="text" id="title" name="title" placeholder="Title Posts" class="flex-4 focus:border-[1px] focus:ring-0  border-[1px] px-4 ring-0 py-2 text-base bg-black/10 border-gray-300 rounded-md <?= isset($errors['title']) ? 'border-red-500' : '' ?>" />
                        <div class="flex-4"></div>
                    </div>
                ...
                <div>
                    <div class="flex items-start justify-between gap-2">
                        ...
                        <div>:</div>
                        <textarea required name="body" id="body" class="flex-8 px-4 py-2 ring-0 focus:ring-0 text-base border-[1px] focus:border-[1px] bg-black/10 border-gray-300 rounded-md <?= isset($errors['body']) ? 'border-red-500' : '' ?>" placeholder="Body Post" rows="10"><?= $post['body'] ?? '' ?></textarea>
                    </div>
